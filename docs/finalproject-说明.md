...
Langfuse针对Agent MCP函数调用轨迹给出一个评估教程，该教程使用pydantic ai SDK（https://langfuse.com/guides/cookbook/example_pydantic_ai_mcp_agent_evaluation），通过experiment完成agent多种评估方式。
